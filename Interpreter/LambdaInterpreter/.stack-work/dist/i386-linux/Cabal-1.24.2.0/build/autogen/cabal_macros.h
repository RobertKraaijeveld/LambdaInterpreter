...
/* package LambdaInterpreter-0.1.0.0 */
#define VERSION_LambdaInterpreter "0.1.0.0"
#define MIN_VERSION_LambdaInterpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "LambdaInterpreter-0.1.0.0-JHYgXxxUj6lFqpIq8bZ5HD"

#define CURRENT_PACKAGE_KEY "LambdaInterpreter-0.1.0.0-JHYgXxxUj6lFqpIq8bZ5HD"
